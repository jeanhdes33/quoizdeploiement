...
function Histoire() {
  ...
  const fetchHistoireQuestion = async () => {
    try {
      const response = await axios.get('http://localhost:8000/questions/histoire/random');
      ...
      console.error('Erreur lors de la récupération de la question d\'histoire :', error);
    }
  };
