...
function CultureGenerale() {
  ...
  const fetchCultureGeneraleQuestion = async () => {
    try {
      const response = await axios.get('http://localhost:8000/questions/culture-generale/random');
      ...
      console.error('Erreur lors de la récupération de la question de culture générale :', error);
    }
  };
