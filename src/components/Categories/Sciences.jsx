...
function Sciences() {
  ...
  const fetchSciencesQuestion = async () => {
    try {
      const response = await axios.get('http://localhost:8000/questions/science/random');
      ...
      console.error('Erreur lors de la récupération de la question de sciences :', error);
    }
  };
