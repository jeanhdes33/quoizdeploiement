...
function Tennis() {
  ...
  const fetchTennisQuestion = async () => {
    try {
      const response = await axios.get('http://localhost:8000/questions/tennis/random');
      ...
      console.error('Erreur lors de la récupération de la question de tennis :', error);
    }
  };
